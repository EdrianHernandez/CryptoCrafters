...
$(document).ready(function() {
    ...
    $('#login-btn').click(function() {
        ...
        signInWithEmailAndPassword(auth, email, password)
            .then((userCredential) => {
                ...
                // Retrieve the selected game from localStorage
                const selectedGame = localStorage.getItem('selectedGame');
                ...
                // Remove the selected game from localStorage after redirection
                localStorage.removeItem('selectedGame');
            })
            .catch((error) => {
    ...
    $('#cryptogram-btn').click(function() {
        localStorage.setItem('selectedGame', 'cryptogram');
        window.location.href = '/signup';
    });

    $('#crossword-btn').click(function() {
