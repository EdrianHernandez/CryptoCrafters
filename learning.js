...
function encrypt() {
    ...
    for (let i = 0; i < plaintext.length; i++) {
        ...
        if (charCode >= 65 && charCode <= 90) {
            ...
            // Convert lowercase to uppercase during encryption
            const upperCharCode = charCode - 32; // Convert to uppercase
            encryptedText += String.fromCharCode(((upperCharCode - 65 + shift) % 26 + 26) % 26 + 65);
        }
        else {
